...
def show_category(category_id):
    ...
    return render_template('category.html', categories=categories, category=cat, items=items)
...
@app.route('/category/new/', defaults={'category_id': None}, methods=['GET', 'POST'])
...
def add_item(category_id):
    ...
    if request.method == 'POST':
        ...
        if name and description and category != "None":
            ...
            return redirect(url_for('show_item', category_id=cat_id, item_id=new_item.id))
        elif category == "None":
        ...
        return render_template('add_item.html', categories=categories, **values)
    else:
        if category_id:
            cat_name = db.get_category(category_id).name
            return render_template('add_item.html', categories=categories, default=cat_name)
        else:
...
def edit_item(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('edit_item.html', category_id=category_id, item_id=item_id, categories=categories,
                               input_name=item.name, input_description=item.description, default_cat=cat.name)
